...
struct EC2024 {
    static func main() {
        ...
        case 16: Quest16.solve(part: part)
        case 17: Quest17.solve(part: part)
        case 18: Quest18.solve(part: part)
        case 19: Quest19.solve(part: part)
        case 20: Quest20.solve(part: part)
